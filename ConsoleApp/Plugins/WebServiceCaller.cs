...
namespace ConsoleApp.Plugins
{
    ...
    public class WebServiceCaller
    {
        ...
        /// ContentType 为application/x-www-form-urlencoded
        /// </summary>
        public static XmlDocument QueryPostFormUrlWebService(String URL, String MethodName, Hashtable Pars)
        {
        ...
        /// <summary>
        /// 需要WebService支持Post调用 
        /// ContentType 为application/json
        /// </summary>
        /// <param name="url"></param>
        /// <param name="method"></param>
        /// <param name="pars"></param>
        /// <returns></returns>
        public static string QueryPostJsonWebService(string url,string method,Hashtable pars)
        {
